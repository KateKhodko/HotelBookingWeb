...
<table>
    <tr>
        ...
        <th><a href="${requestScope.pagination.url}?${InputForm.LIMIT}=${requestScope.inputForm.limitValue}&${OrderByForm.orderByName}=arrivalDate"><fmt:message key="locale.orders.arrival" /></a></th>
        <th><a href="${requestScope.pagination.url}?${InputForm.LIMIT}=${requestScope.inputForm.limitValue}&${OrderByForm.orderByName}=departDate"><fmt:message key="locale.orders.depart" /></a></th>
